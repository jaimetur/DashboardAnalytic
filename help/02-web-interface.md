...
| **Administration** | Manage users, shared templates, portable imports/exports, the active workspace database and audit activity; restricted to authorised administrators. |
