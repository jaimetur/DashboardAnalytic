...
- **Report Charts**: render every automated chart from the selected Slides Template using the same CDR selection, technology and scope, without creating a PowerPoint file. The latest workspace chart set remains available until regenerated and supports enlarged sequential viewing.
