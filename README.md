...
- **Report Charts**: render every automated chart from the selected Slides Template using the same CDR selection, technology and scope, without creating a PowerPoint file.
