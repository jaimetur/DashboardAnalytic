...
- Made every App Logs filter derive its selectable values, including dates and event types, from every row loaded in the table, including cards hidden by compact-phone pagination, and refresh those options together with live log data.
