...
- Renamed the Workspace queue heading to Datasets and replaced dataset, user, template and database row actions with compact circular icon controls carrying accessible labels.
