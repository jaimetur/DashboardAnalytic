...
- Updated NSA slides 8–15 with the requested operator scope, G Level 4 and horizontal/vertical grouping rules, corrected Speech/LQ sources for POLQA slides, the 1.6 thresholds, and the VoLTE/MultiRAB call scope. Slides 16 onward received only the structural grouping migration and no KPI/filter changes.
