...
- Slides Templates now belong to individual workspaces, including the template registry and CSV files; Database Management exposes the registry as Slides Templates registry under Workspace Tables. Existing workspaces receive independent copies of the former shared library; newly created workspaces, including Default, start without templates.
